...
public class SignInActivity extends AppCompatActivity {
    ...
    Button loginbtn;
    TextView signup,employee_login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(passwordtext.length()<7)
                    error+="\nInvalid Password";
                if (AppContants.isValidMail(emailtxt) &&passwordtext.length() > 6){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(SignInActivity.this, R.style.AlertDialogCustom).create();
        ...
        employee_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SignInActivity.this, SignInEmployeeActivity.class));
            }
        });
    }

    private void login(String mailTxt, String passwordTxt) {
        dialog = new ProgressDialog(SignInActivity.this, R.style.AlertDialogCustom);
        ...
        Log.e("my URL: ", url);
        RequestQueue r = Volley.newRequestQueue(SignInActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            profileItem = new ProfileItem(UserId,
                                    Name,
                                    Email,
                                    Password,
                                    Status,
                                    ...
                                    Available);
                            if (RoleId.equals("3"))
                                startActivity(new Intent(SignInActivity.this, CitizenActivity.class));
                            else if (RoleId.equals("2"))
                                startActivity(new Intent(SignInActivity.this, CollectorActivity.class));
                            else {
                                showMsg();
                            }
                        } catch (Exception e) {
